class User:
    def __init__(self, username, password, role, name, phone_number, email, gender, governorate, age, national_id):
...
class Admin(User):
    def __init__(self, username, password, name, phone_number, email, gender, governorate, age, national_id):
        super().__init__(username, password, role="Admin", name=name, phone_number=phone_number, email=email,
                         gender=gender, governorate=governorate, age=age, national_id=national_id)

# NormalUser class inherits from User
