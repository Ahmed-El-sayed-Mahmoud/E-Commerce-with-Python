...
class RegistrationPage:
    def __init__(self):
        ...
        frame = tk.Frame(self.root, bg="#ffffff", padx=30, pady=30, relief="raised", bd=2)
        frame.pack(expand=True, fill='both')

        titleLabel = tk.Label(frame, text="Register", font=("Arial", 18), bg="#ffffff")
        titleLabel.pack(pady=10)

        # Fields for registration
        tk.Label(frame, text="Name", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.name_entry = tk.Entry(frame, width=30, font=("Arial", 12))
        self.name_entry.pack(pady=5)

        tk.Label(frame, text="Phone Number", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.phone_entry = tk.Entry(frame, width=30, font=("Arial", 12))
        self.phone_entry.pack(pady=5)

        tk.Label(frame, text="Email", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.email_entry = tk.Entry(frame, width=30, font=("Arial", 12))
        self.email_entry.pack(pady=5)

        tk.Label(frame, text="Password", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.password_entry = tk.Entry(frame, width=30, font=("Arial", 12), show="*")
        self.password_entry.pack(pady=5)

        tk.Label(frame, text="National ID", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.national_id_entry = tk.Entry(frame, width=30, font=("Arial", 12))
        self.national_id_entry.pack(pady=5)

        tk.Label(frame, text="Age", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        ...
        tk.Label(frame, text="Gender", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        ...
        tk.Label(frame, text="Governorate", font=("Arial", 12), bg="#ffffff").pack(pady=5)
        self.governorate_menu = OptionMenu(frame, self.governorate_var, "Cairo", "Alexandria", "Giza", "Aswan", "Luxor", "Other")
        self.governorate_menu.pack(pady=5)

        self.registerButton = tk.Button(frame, text="Register", font=("Arial", 12), bg="#4caf50", fg="white",
                                        activebackground="#45a049", width=20, command=self.register)
